...
public class EmojiKeyboard extends LinearLayout {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        emojis.append(R.drawable.emoji_cool, "^cool^");
        ...
        emojis.append(R.drawable.emoji_angry4, ":angry4:");
        emojis.append(R.drawable.emoji_angry_hot, "^angryhot^");
        emojis.append(R.drawable.emoji_angry, "^angry^");
        ...
        emojis.append(R.drawable.emoji_shocked, "^shocked^");
